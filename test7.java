...
class fff {
    public static void main(String[] args) {
        ...
        for (int j = 0; j < grades.length; j++) {
            ...
            System.out.println("學生" + (j + 1) + " total:" + total);
            // System.out.println("length:" + grades.length);
            double avg = (double) total / grades.length;

            System.out.println("學生" + (j + 1) + " 平均成績是:" + avg);
...
class ggg {
    public static void main(String[] args) {
        ...
        int number = s.nextInt();
        int[][] grades = new int[number][2];
        String[] studentNames = new String[number]; // 新增的學生名稱陣列
        //
        ...
        for (int i = 0; i < grades.length; i++) {
            System.out.println("請輸入學生 " + (i + 1) + " 的名稱");
            studentNames[i] = s.next(); // 讀取學生名稱
            System.out.println("學生 " + (i + 1) + " 的國文成績");
            grades[i][0] = s.nextInt();
            System.out.println("學生 " + (i + 1) + " 的數學成績");
            grades[i][1] = s.nextInt();
        ...
        System.out.println("成績列表：");
        for (int i = 0; i < grades.length; i++) {
            System.out.println("學生 " + studentNames[i] + ": " + Arrays.toString(grades[i]));
        }
        ...
        for (int j = 0; j < grades.length; j++) {
            ...
            System.out.println("學生" + studentNames[j] + " total:" + total);
            // System.out.println("length:" + grades.length);
            double avg = (double) total / grades.length;

            System.out.println("學生" + studentNames[j] + " 平均成績是:" + avg);
